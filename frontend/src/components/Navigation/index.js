    ...
    return(
        <>
            ...
            <ul className='navbar-elements-wrapper'>
                ...
                <div className='navbar-session-buttons-wrapper'>
                    {sessionLinks}
                </div>
            </ul>
        </>
